...
const displaySearch = booksData => {
    ...
    if (books.length === 0) {
        foundNumber.innerText = `No book found`;
    }

    // if search element is in api, display it 
    else {
        foundNumber.innerText = `Number of books found: ${booksData.numFound}`;
        ...
        books.slice(0, 30).forEach(book => {
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text"><u>Publishing Year</u>: <b>${book.first_publish_year}!="Undefined" ? ${book.first_publish_year} : "unknown"</b></p>
